...
import  LogoAPI  from "../../Assets/image/logo Search API 1.png"
...
export const ModalComment = ({ setOpenModalComment }: iPropsCard) => {
    ...
    const { commentFilter, deleteCommentAdmin, PegaInfoCard, PegaIDCard, listCommentsRequestAdmin, infoUser } = useContext (AdminContext)
        ...
        <StyledModalComment>
            <div className="divModal">
                ...
                <div className="divInfoApi">
                    <img src={LogoAPI} alt="Imagem da API" />
                ...
                <div className="divComment">
                    ...
                    {commentFilter.length === 0 ? 
                        <p className="loddingComment">Deixe seu um comentário sobre esta API</p>
                    : 
                            ...
                            return (
                                <div className="Comment" key={index}>
                                    <div className="infoUser">
                                        ...
                                        {infoUser?.isAdmin ?
                                            <button onClick={()=>deletCommentRelod(itens.uuid)}><RiDeleteBinLine /></button>
                                            :
                ...
                <div className="divBTN">
                    <button className="BtnBlue" onClick={() =>  setOpenModalWrite(true)}>Adicionar Comentario</button>
                    {OpenModalWrite ? <ModalWriteComment setOpenModalWrite={setOpenModalWrite}/> : null}
    
                    <a className="BtnRed" target="blank" href={PegaInfoCard!.link}>Documentação</a>
                </div>
            </div>
        </StyledModalComment>
    )
